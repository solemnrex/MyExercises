...
Public Class Form1
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Text = "重载铁路基床结构设计程序（科研版） V 1.00"
...
#Region "1-分担比计算"
        ...
        For i = Ceiling(p_out.Length / 2) To 0 Step -1
            Dim num = p_out(i)
            If num > pmax Then
                pmax = num
...
#Region "2-计算应力函数与动力影响深度"
        ...
        Else
            bed_c = Val(ComboBox2.Text) : gamma_m = 20.5
            q_g = 20.726
        End If
        p_load = Val(ComboBox1.Text)
...
#Region "5-输出结果（计算书）"
        ...
        With TextBox4
            ...
            .Text = "计算说明书" & vbCrLf &
                            ...
                            "2.表层强度复核" & vbCrLf &
                            "表层极限动应力" & Space(5) & "<" & Space(5) & "表层允许动应力除以安全系数" & vbCrLf &
                              Space(10) & Format(biaoceng_sigma_djx, "#0.00") & "kPa" & Space(10) & Format(biaoceng_sigma_dyx / safefactor, "#0.00") & "kPa" & vbCrLf &
